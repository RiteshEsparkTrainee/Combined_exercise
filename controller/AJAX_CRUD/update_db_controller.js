...
try{
var update_db = async function (req, res) {
    ...
    const update_data = (query) => {
      return new Promise(function (resolve, reject) {
        con.query(query, function (err, result) {
          if (err) {
            // console.log("asdddddddddddddddddddd",err)
            console.log(err)
            reject(err)
          }
          else {
    ...
    if (data.board_name !== undefined) {
      ...
      // console.log("my language  count " , language_count)
      ...
      console.log(languages_known_values,"doisfji")
      ...
      // console.log(technology_checkBox.length)
